        ...
        <section class="px-4 md:px-8 lg:px-12 xl:px-20 py-16">
            ...
            <div class="flex flex-col items-center justify-center pt-8">
              <div class="flex items-center mb-4">
                <input id="default-checkbox" type="checkbox" required value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
              ...
              <div>
                <a
                    href=""
                    class="text-white bg-primary-600 rounded-lg w-full active:scale-95 will-change-transform overflow-hidden duration-100 transition-all font-medium text-sm px-4 py-3 "
                  >
                    شرکت در نظرسنجی
                </a>
              </div>
