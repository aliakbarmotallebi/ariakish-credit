                    ...
                    <section class="w-full">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-2 ">
                            <label class="relative cursor-pointer">
                                ...
                                <div for="box-1"
                                    class="text-left pl-4 rounded-lg border-gray-200 border-2 peer-checked:bg-blue-100 peer-checked:border-blue-500 py-4 w-full text-sm font-medium text-gray-900">
