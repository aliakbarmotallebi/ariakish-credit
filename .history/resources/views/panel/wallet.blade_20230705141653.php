                ...
                <section class="w-full">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-2 ">
                        <label class="relative block">
                            ...
                            <div for="box-1" class="text-left pl-4 rounded-lg border-gray-200 border-2 peer-checked:border-blue-500 py-4 w-full text-sm font-medium text-gray-900">
                                ...
                                <div class="text-right text-gray-800 text-xs font-medium px-2.5 py-0.5 before:content-['-']">
                                    معادل یک میلیون تومان
                                </div>
                                <div class="text-right text-xs font-medium px-2.5 py-0.5 text-neutral-500 before:content-['-']">
                                    مبلغ اعتبار کیف پول دو میلیون تومان
                                </div>
                            </div>
                        </label>
                        <label class="relative block">
                            <input id="box-2" type="radio" name="suggest" class="peer hidden">
                            <div for="box-2" class="text-left pl-4 rounded-lg border-gray-200 border-2 peer-checked:border-blue-500 py-4 w-full text-sm font-medium text-gray-900">
                                <span class="font-semibold text-lg">
                                ...
                                <div class="text-right text-gray-800 text-xs font-medium px-2.5 py-0.5 before:content-['-']">
                                    معادل دو میلیون تومان
                                </div>
                                <div class="text-right text-xs font-medium px-2.5 py-0.5 text-neutral-500 before:content-['-']">
                                    مبلغ اعتبار کیف پول چهار میلیون تومان
                                </div>
                            </div>
                        </label>
                        <label class="relative block">
                            <input  id="box-3" type="radio" name="suggest" class="peer hidden">
                            <div for="box-3" class="text-left pl-4 rounded-lg border-gray-200 border-2 peer-checked:border-blue-500 py-4 w-full text-sm font-medium text-gray-900">
                                <span class="font-semibold text-lg">
                                ...
                                <div class="text-right text-gray-800 text-xs font-medium px-2.5 py-0.5 before:content-['-']">
                                    معادل پنج میلیون تومان
                                </div>
                                <div class="text-right text-xs font-medium px-2.5 py-0.5 text-neutral-500 before:content-['-']">
                                    مبلغ اعتبار کیف پول ده میلیون تومان
                                </div>
                            </div>
                        </label>
                    <div class="col-sapn-1 lg:col-span-3 flex items-center justify-center space-x-2 space-x-reverse pt-3 col-span-3">
                        <div>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-100">
                                ...
                                <td scope="row" class="px-6 py-4 text-center  whitespace-nowrap">
                                    ...
                                    <div class="text-green-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="inline fill-current w-4 h-4" viewBox="0 0 24 24"><path d="M11.9997 10.8284L7.04996 15.7782L5.63574 14.364L11.9997 8L18.3637 14.364L16.9495 15.7782L11.9997 10.8284Z"></path></svg>
                                        واریز به کیف پول
                                    </div>
                                    @else
                                    <div class="text-rose-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="inline fill-current w-4 h-4" viewBox="0 0 24 24"><path d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z"></path></svg>
                                        برداشت از کیف پول
                                    </div>                            
                                    @endif
                                </td>
