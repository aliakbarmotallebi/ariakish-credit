...
<div class="px-20 py-16">
    <div class="card">
        <div class="bg-primary h-12 rounded-t-xl relative">
            <div class="flex absolute -top-1/2 -translate-y-1/3 right-12 items-center justify-center bg-white rounded-full p-6 border-4 border-main">
      ...
      />
        ...
        <div class="p-3">
            <form class="grid grid-cols-2 gap-3 items-stretch" action="#">
                <div class="flex flex-col">
                    <label class="text-sm" for="name"> نام </label>
                    <input type="text" id="name" name="name" class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50" />
                </div>
                <div class="flex flex-col">
                    <label class="text-sm" for="national-code">
        کد ملی
      </label>
                    <input type="text" id="national-code" name="national-code" class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50" />
                </div>
                <div class="flex flex-col">
                    <label class="text-sm" for="phone">
        شماره ثابت
      </label>
                    <input type="text" id="phone" name="phone" class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50" />
                </div>
                <div class="flex flex-col">
                    <label class="text-sm" for="phone">
        شماره همراه
      </label>
                    <input type="text" id="mobile" name="mobile" class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50" />
                </div>
                <div class="flex flex-col">
                    <label class="text-sm" for="phone">
        شماره همراه 2
      </label>
                    <input type="text" id="mobile-2" name="mobile-2" class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50" />
                </div>
                <div class="flex flex-col">
    ...
    <div class="flex flex-col">
      <label class="text-sm" for="address">آدرس</label>
                    <textarea name="address" id="address" rows="3" class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50"></textarea>
                </div>
                <div class="flex flex-col">
                    <p class="text-sm" for="address">تصویر کارت ملی</p>
                    <div rows="3" for="national-cart" class="flex h-[86px] justify-between items-start border mt-3 border-line rounded-md p-1.5 bg-main/50">
                        <div class="w-1/2 h-full">
                            <img src="./assets/images/national-card.png" alt="national-card" />
                        </div>
                        <label for="national-cart" class="text-link cursor-pointer border px-3 py-1 bg-main hover:bg-main/5 transition-all duration-200 rounded">
          <svg
            width="14"
            height="14"
            viewBox="0 0 14 14"
    ...
    <div class="mt-4 text-left">
        <button class="bg-primary text-white text-sm rounded-md py-1.5 px-4 hover:bg-primary/80 transition-all duration-200">
  ویرایش پروفایل
</button>
    </div>
</div>
