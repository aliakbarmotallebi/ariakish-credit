                    ...
                    <div class="grid grid-cols-3 gap-2 ">
                        ...
                        <label class="relative">
                            ...
                            <div for="box-2" class="rounded-lg border-gray-200 border-2 peer-checked:border-blue-500 py-4 w-full text-sm font-medium text-gray-900>
                                ...
                                <div class="text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded mr-1 text-xs text-green-700 font-semibold ">
                                    معادل یک میلیون تومان
                                </div>
                                <div class="text-xs font-medium px-2.5 py-0.5 text-neutral-500">
