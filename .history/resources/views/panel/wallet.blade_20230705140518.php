            ...
            <div class="card border rounded-lg overflow-hidden p-5">
                <section class="w-full">
                    <div class="grid grid-cols-3 gap-2 ">
                        ...
                        <label class="relative">
                            <input id="box-2" type="radio" name="suggest">
                            <div for="box-2" class="rounded-lg border-gray-200 border-2 peer-checked:border-blue-500 py-4 w-full text-sm font-medium text-gray-900>
                                ...
                                <div class="bg-green-100 text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded mr-1 text-xs text-green-700 font-semibold ">
                        ...
                        <label class="relative">
                            <input  id="box-3" type="radio" name="suggest">
