            ...
            <div class="p-10">
                <form class="grid grid-cols-2 gap-3" action="#">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" id="phone" name="phone" value="{{ $user->fullname }}"
                            class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50" />
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm" for="phone">
                        ...
                        <input type="text" id="mobile" name="mobile" value="{{ $user->fullname }}"
                            class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50" />
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm" for="phone">
                        ...
                        <input type="text" id="mobile-2" name="mobile-2" value="{{ $user->fullname }}"
                            class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50" />
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm" for="zip-code">کد پستی</label> 
                        <input type="text" id="zip-code" name="zip-code" value="{{ $user->fullname }}"
                            class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50" />
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm" for="address">آدرس</label>
                        <textarea name="address" id="address" rows="3"
                            class="border mt-3 border-line rounded-md py-1.5 focus:outline-none focus-within:border-textMain px-4 bg-main/50">{{ $user->fullname }}</textarea>
                    </div>
                    <div class="flex flex-col">
                        ...
                        @else 
                            <label for="national-cart"
                                class="mt-3 text-neutral-700 border-neutral-800 cursor-pointer border-dashed px-3 py-1 transition-all duration-200 rounded">
