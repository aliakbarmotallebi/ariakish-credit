...
@section('content')
    <div class="px-4 md:px-8 lg:px-12 xl:px-20 py-16">
        <a href="button" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
