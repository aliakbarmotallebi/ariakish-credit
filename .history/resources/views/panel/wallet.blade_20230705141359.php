            ...
            <div class="card border rounded-lg overflow-hidden p-5">
                <section class="w-full">
                    <div class="grid grid-cols-3 gap-2 ">
                        <label class="relative text-right">
                            ...
                            <div for="box-1" class="text-left pl-4 rounded-lg border-gray-200 border-2 peer-checked:border-blue-500 py-4 w-full text-sm font-medium text-gray-900">
                                ...
                                <div class="text-gray-800 text-xs font-medium px-2.5 py-0.5 before:content-['-']">
                                    معادل یک میلیون تومان
                                </div>
                                <div class="text-xs font-medium px-2.5 py-0.5 text-neutral-500 before:content-['-']">
