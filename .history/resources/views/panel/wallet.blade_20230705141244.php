                ...
                <section class="w-full">
                    <div class="grid grid-cols-3 gap-2 ">
                        <label class="relative">
                            ...
                            <div for="box-1" class="text-left pr-4 rounded-lg border-gray-200 border-2 peer-checked:border-blue-500 py-4 w-full text-sm font-medium text-gray-900">
                        ...
                        <label class="relative">
                            ...
                            <div for="box-2" class="text-left pr-4 rounded-lg border-gray-200 border-2 peer-checked:border-blue-500 py-4 w-full text-sm font-medium text-gray-900">
                                <span class="font-semibold text-lg">
                        ...
                        <label class="relative">
                            ...
                            <div for="box-3" class="text-left pr-4 rounded-lg border-gray-200 border-2 peer-checked:border-blue-500 py-4 w-full text-sm font-medium text-gray-900">
                                <span class="font-semibold text-lg">
