            ...
            <form class="grid grid-cols-3 gap-5 items-stretch" action="">
                <div>
                    ...
                    <select name="brand_name"
                        class="select3 @error('brand_name') error-input @enderror  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
                        <option></option>
                ...
                <div wire:ignore>
                    ...
                    <select id="variantName" wire:model="variant_name" 
                        class="select2 @error('variant_name') error-input @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
                        <option></option>
