...
@section('content')
    <div class="px-4 md:px-8 lg:px-12 xl:px-20 py-16">
        <section class="container mx-auto mt-10">
            <div class="bg-white border rounded-none md:rounded-lg">
              <div class="py-9 text-center border-b">
                <h1 class="text-2xl font-medium">راهنمایی شرکت در نظرسنجی</h1>
                <h5 class="text-neutral-800 pt-4">قوانین نظرسنجی</h5>
              </div>
              <div class="p-5">
