<x-guest title="پنل مدیریت سامانه تعمیرات">
	<div class="min-h-screen bg-neutral-700 flex flex-col justify-center">
	...
	<form method="POST">
		<section
			...
			<div class="space-y-4">
				...
				<button
					type="submit"
					class="w-full flex justify-center rounded-2xl border-b-4 border-b-pink-600 bg-pink-500 py-3 font-bold text-white hover:bg-pink-400 active:translate-y-[0.125rem] active:border-b-pink-400">
