...
@section('content')
        <section class="px-4 md:px-8 lg:px-12 xl:px-20 py-16">
            ...
            <div class="flex flex-col items-center justify-center pt-8">
              <div class="space-x-5 space-x-reverse">
                <a
                ...
                <a
                href="{{ route('logout') }}"
                class="bg-gray-100 text-gray-800 hover:bg-gray-100/50 focus:ring-4 focus:outline-none focus:ring-gray-100/30 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
              خروج از سیستم
              </a>
              </div>
            </div>
