...
@section('title', 'مدیریت مدل ها')
@section('content')
<x-layout.header title="لیست مدل ها">
    <x-slot name="icon">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8"  viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M3 10H2V4.003C2 3.449 2.455 3 2.992 3h18.016A.99.99 0 0 1 22 4.003V10h-1v10.001a.996.996 0 0 1-.993.999H3.993A.996.996 0 0 1 3 20.001V10zm16 0H5v9h14v-9zM4 5v3h16V5H4zm5 7h6v2H9v-2z"/></svg>
    </x-slot>
    <x-slot name="little">
       شما در این بخش مدیریت مدل ها اعم از ایجاد و حذف و نمایش لیست انها
    </x-slot>
</x-layout.header>

<x-layout.cart title="افزدون مدل جدید" >
    <x-slot name="header" class="!p-0">
    </x-slot>
    <x-slot name="content">
        <form action="{{ route('dashboard.content.variants.store') }}" method="POST">
            @csrf
            <div class="flex items-center gap-3 px-8 py-4">
                <x-form.input label="نام مدل" name="name" required/>
...
<x-layout.cart title="لیست مدل ها" >
    <x-slot name="header" class="!p-0">
